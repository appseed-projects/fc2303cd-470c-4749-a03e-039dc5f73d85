...
- Timestamp: `2022-05-24 09:19`
- Build ID: `fc2303cd-470c-4749-a03e-039dc5f73d85`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/fc2303cd-470c-4749-a03e-039dc5f73d85.git
$ cd fc2303cd-470c-4749-a03e-039dc5f73d85
```
